...
const ProjectsProjectIdEstuariesRoute = ProjectsProjectIdEstuariesRouteImport.update({
  id: "/estuaries",
  path: "/estuaries",
  getParentRoute: () => ProjectsProjectIdRoute,
} as any);
...
const ProjectsProjectIdEstuariesIndexRoute = ProjectsProjectIdEstuariesIndexRouteImport.update({
  id: "/",
  path: "/",
...
const ProjectsProjectIdEstuariesIdRoute = ProjectsProjectIdEstuariesIdRouteImport.update({
  id: "/$id",
  path: "/$id",
  getParentRoute: () => ProjectsProjectIdEstuariesRoute,
} as any);
...
const ProjectsProjectIdEstuariesRouteWithChildren =
  ProjectsProjectIdEstuariesRoute._addFileChildren(ProjectsProjectIdEstuariesRouteChildren);
